export default function ContactSection() {
  return (
    <section className=" relative z-10 overflow-hidden text-black py-20 lg:py-[120px] ">
        ...
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              <h2 className="mb-6 text-[32px] font-semibold uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px]">
