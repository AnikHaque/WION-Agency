    ...
    <section className="relative z-20 overflow-hidden bg-white pb-12 pt-20  lg:pb-[90px] lg:pt-[120px]">
      <div className=" max-w-7xl px-4  mx-auto">
        ...
        <div className="-mx-4 flex flex-wrap text-black">
          <div className="w-full px-4 lg:w-1/2 text-black">
            <AccordionItem
...
const AccordionItem = ({ header, text }) => {
  ...
  return (
    <div className=" max-w-7xl mx-auto px-4 mb-8  rounded-lg bg-white p-4 shadow-[0px_20px_95px_0px_rgba(201,203,204,0.30)] dark:bg-dark-2 dark:shadow-[0px_20px_95px_0px_rgba(0,0,0,0.30)] sm:p-8 lg:px-6 xl:px-8">
      <button
