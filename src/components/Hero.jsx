...
<div>
<h1 className="text-5xl font-bold leading-tight mb-5">We Build Modern Digital Experiences</h1>
...
<button className="px-6 py-3 bg-blue-600 text-white rounded-lg text-lg font-medium hover:bg-blue-700 transition">Get Started</button>
</div>
<div>
